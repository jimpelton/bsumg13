...
# flips each row to match the well orders with the 485 images.
# returns: list of well samples at time t,
# each row contains 96 well values.
#
# file format is well#:wellValue
#
...
# returns: list of well samples at time t, each row
# contains 96 well values.
#
# file format is well#:wellValue
#
